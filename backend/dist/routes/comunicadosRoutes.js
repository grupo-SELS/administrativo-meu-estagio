...
router.post('/comunicados', rateLimitMiddleware_1.strictRateLimit, devAuthBypass, uploadMiddleware_1.uploadMiddleware, uploadMiddleware_1.processUploads, validationMiddleware_1.sanitizeBody, (0, validationMiddleware_1.validateFileType)(['jpg', 'jpeg', 'png', 'gif', 'webp']), (0, validationMiddleware_1.validateFileSize)(5), controller.criar.bind(controller));
